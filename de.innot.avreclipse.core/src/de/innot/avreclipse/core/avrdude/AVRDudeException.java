...
public class AVRDudeException extends Exception {
	...
	public enum Reason {
		UNKNOWN, NO_AVRDUDE_FOUND, CANT_ACCESS_AVRDUDE, CONFIG_NOT_FOUND, UNKNOWN_MCU, UNKNOWN_PROGRAMMER, NO_PROGRAMMER, PORT_BLOCKED, TIMEOUT, PARSE_ERROR, INVALID_CWD;
	}
